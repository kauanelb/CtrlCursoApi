...
$nmCurso         = trim($jsonParam['nmCurso'] ?? '');
...
$sql = "
    INSERT INTO aluno (nmAluno, nmCurso, dtMatricula, dtNascimento, nrTelefone, idCursoCadastro)
    VALUES (?, ?, ?, ?, ?, ?)
";
...
// 5. Bind e Execução
// Tipagem: s (nmAluno), s (nmCurso), s (dtMatricula), s (dtNascimento), s (nrTelefone), i (idCursoCadastro)
$stmt->bind_param("sssssi", $nmAluno, $nmCurso, $dtMatricula, $dtNascimento, $nrTelefone, $idCursoCadastro);
