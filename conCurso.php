...
// NOVO SQL: Seleciona todos os campos da tabela 'curso'
$sql = "SELECT idCurso, nmSigla, nmCurso, nrCargaHoraria FROM curso ORDER BY nmCurso";
...
if ($result && $result->num_rows > 0) {
    ...
    // Resposta de erro/vazia: Estrutura baseada nos campos da tabela 'curso'
    $response[] = [
        "idCurso" => 0,
        "nmSigla" => "",
        "nmCurso" => "",
